...
class CellStem1(nn.Module):
    ...
    def __init__(self, in_channels_x, in_channels_h, out_channels):
        ...
        #self.path_2.add_module('maxpool', nn.MaxPool2d(1, stride=2, ceil_mode=True)) # ceil mode for padding
    ...
    def forward(self, x_conv0, x_stem_0):
        ...
        # path 2
        #print(x_relu.shape)
        #x_relu2 = torch.zeros_like( x_relu )
        #x_relu2[:,:,:-1,:-1] = x_relu[:,:,1:,1:].clone()

        #x_path2 = self.path_2(x_relu2)
        x_path2 = self.path_2(x_relu[:,:,1:,1:])
        #print('path_2',x_path2)
        #print(x_path2.shape)
        # final path
